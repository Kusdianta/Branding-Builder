...
class AnalyzeBrandTest extends TestCase
{
    ...
    #[Test]
    public function it_seeds_the_twelve_step_pipeline_in_phase_order(): void
    {
        Bus::fake();
        ...
        $this->assertSame([
            ...
            '4:validate:validate_evidence',
            '5:score:score_recall',
            '6:score:score_digital',
            '7:score:score_konsistensi',
            '8:score:score_experience',
            '9:final:generate_recommendations',
            '10:final:generate_quick_wins',
            '11:final:generate_positioning',
            '12:final:generate_pdf',
        ], $steps);
    }
