...
>
    {{-- BB33: minimal audit-focused nav.
         ...
         BB123/BB124: auth-aware chrome moved into reusable components
         (<x-credit-chip />, <x-profile-nav />). Both render only when
         authenticated; guests see a "Masuk" CTA instead. --}}
    <x-slot name="cta">
