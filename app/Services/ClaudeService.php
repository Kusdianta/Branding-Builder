...
- Untuk `quick_wins`: 5-7 aksi (TIDAK BOLEH KURANG DARI 5) yang bisa dieksekusi <1 minggu dengan effort rendah. Contoh: "Tambahkan call-to-action 'WA via link bio' di setiap caption reels", "Pin 3 post terbaik ke top grid". JANGAN copy dari `priority_recommendations`. Format tiap item: "Aksi singkat — penjelasan rinci 1-2 kalimat" dengan em-dash (—) sebagai pemisah aksi dan penjelasan. Tetap satu string per item (BUKAN objek).
